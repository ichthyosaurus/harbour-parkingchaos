...
# This project moved to [Codeberg](https://codeberg.org/ichthyosaurus/harbour-parkingchaos)

> [!WARNING]
> **Development of Parking Chaos has moved to
> [Codeberg](https://codeberg.org/ichthyosaurus/harbour-parkingchaos).
> Please update your bookmarks and local clones to point to the new URL.**
>
>     git remote set-url origin https://codeberg.org/ichthyosaurus/harbour-parkingchaos
>     git fetch
